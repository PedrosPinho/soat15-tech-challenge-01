...
clienteRouter.get('/', authMiddleware, (req, res, next) => controller.list(req, res, next));

clienteRouter.get('/:id', authMiddleware, (req, res, next) => controller.getById(req, res, next));
