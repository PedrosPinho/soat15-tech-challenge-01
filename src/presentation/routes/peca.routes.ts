...
pecaRouter.post('/', authMiddleware, requireInternalScope, validateCreatePeca, (req, res, next) =>
  getController().create(req, res, next),
);

pecaRouter.get('/', authMiddleware, requireInternalScope, (req, res, next) => getController().list(req, res, next));

pecaRouter.get('/:id', authMiddleware, requireInternalScope, (req, res, next) => getController().getById(req, res, next));

pecaRouter.put('/:id', authMiddleware, requireInternalScope, validateUpdatePeca, (req, res, next) =>
  getController().update(req, res, next),
);

pecaRouter.delete('/:id', authMiddleware, requireInternalScope, (req, res, next) =>
